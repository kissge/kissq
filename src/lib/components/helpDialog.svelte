...
<div bind:this={dialog} style:display={hide ? 'none' : 'block'}>
	...
	<ol>
		<li>
			...
			<ul>
				<li>
					USB経由で給電されるため、電源ケーブルは<del>不要です。</del><ins>繋がないでください。</ins
					>
				</li>
			</ul>
		</li>
		<li>
			「その他」の「早稲田式連携」ボタンをクリックします<del
				>（以前に接続したことがある場合、自動的に接続されるためこの工程以降は不要です）。</del
			>
		</li>
		<li>
	...
	<ol>
		<li>
			早稲田式早押しボタンの親機に繋がっているUSBケーブル<del>（と電源ケーブル）</del
			>を抜き、電源を切ります。
		</li>
